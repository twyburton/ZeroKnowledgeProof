...
public class PoKTesting {
	...
	public void PoKTesting() {
		...
		PoKVerifier victor = new PoKVerifier(G,3);
		...
		bases.add(g);
		exponents.add(r);
		PoKComponentProver c1X1 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		bases.add(h);
		exponents.add(r);
		PoKComponentProver c1X2 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		bases.add(c);
		exponents.add(r);
		PoKComponentProver c1X3 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		// -- PoK --
		peggy = new PoKProver(G);
		victor = new PoKVerifier(G,3);
		...
		bases.add(g);
		exponents.add(t);
		PoKComponentProver c2X1 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		bases.add(h);
		exponents.add(t);
		PoKComponentProver c2X2 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		exponents.add(Crypto.multiplyList(nbsList));
		bases.add(c);
		exponents.add(t);
		PoKComponentProver c2X3 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		bases.add(h);
		exponents.add(x2);
		PoKComponentProver c3X1 = PoKComponentProver .generateProver(G, bases, exponents);
		...
		exponents.add(Crypto.multiplyList(nzx1List));
		bases.add(u2d);
			List<BigInteger> nzx2List = new ArrayList<BigInteger>(); nzx2List.add(BigInteger.valueOf(-1)); nzx2List.add(z); nzx2List.add(x2);
		exponents.add(Crypto.multiplyList(nzx2List));
		PoKComponentProver c3X2 = PoKComponentProver .generateProver(G, bases, exponents);
