 ...
 * @author twyburton
 */
public class CyclicGroupOld implements Serializable {
	...
	public CyclicGroupOld( final BigInteger p , final BigInteger q, final BigInteger g){
		this.p = p;
		this.q = q;
		this.g = g;
	...
	public CyclicGroupOld( final String p , final String q, final String g){
	 ...
	 */
	public static CyclicGroupOld generateGroup( int bitLength ){
		...
		return new CyclicGroupOld( p , q , g );
